...
def main() -> None:
    ...
    start_date, end_date, run, force_refresh, selected_signals, sic_search, company_name_search, shortlisted_only, min_directors, max_directors = render_sidebar(default_start, default_end)
